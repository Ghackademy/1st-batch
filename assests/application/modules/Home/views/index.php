...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assests/css/jRating.jquery.css">
        <script type="text/javascript" src="<?php echo base_url();?>assests/js/jRating/jquery.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>assests/js/jRating/jRating.jquery.js"></script>
                ...
                <div class="col-md-3 col-xs-12 col-sm-6 col-lg-3">
                    <div id="sidebar">
                        ...
                        <ul class="sidebarlist">
                                ...
                                <li><a href="<?php base_url(); ?>category/allpost/<?php echo $category['cat_slug']; ?>"><?php echo $category['cat_title']; ?></a></li>
                        ...
                        <a href="product_details.html">
                         ...
                         <p><?php echo $p['price']; ?></p>
                            <div id="wrapper" class="col-md-10 col-xs-12 col-sm-12 col-lg-10 center-block" >
                                <input type="radio" id="star1" name="rating" name="demo_button" value="1" class="star" data-id="9"/>
