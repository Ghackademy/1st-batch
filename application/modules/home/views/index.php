                            ...
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img src="<?php echo base_url(); ?>assets/images/bg1-bannersequence.jpg" alt="...">
                                    ...
                                    <div class="item">
                                        ...
                                        <img src="<?php echo base_url(); ?>assets/images/bg2-bannersequence.jpg" alt="...">
                                        <div class="carousel-caption">
                                            this is girl
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 col-lg-3">
                            ...
                            <div class="advertisement row">
                                <img src="<?php echo base_url(); ?>assets/images/block1.jpg" alt="advertisement 1">
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 col-lg-3 ">
                            <div class="advertisement">
                                <img src="<?php echo base_url(); ?>assets/images/block2.jpg" alt="advertisement 1">
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 col-lg-3">
                            <div class="advertisement">
                                <img src="<?php echo base_url(); ?>assets/images/block3.jpg" alt="advertisement 1">
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 col-lg-3">
                            <div class="advertisement">
                                <img src="<?php echo base_url(); ?>assets/images/banner1-images.png" alt="advertisement 1">
                            </div>
                        </div>
                        <hr color="orange"> 
                    </div>
