                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo1" class="collapse side nav">
                            ...
                            <li>
                                 <a href="<?php echo base_url(); ?>home/viewproducts">view Product</a>
                                <a href="<?php echo base_url(); ?>home/addproduct">Add Product</a>
                        </ul>
                    </li>
                 ...
                 <div class="dash-tile dash-tile-2x">
                       ...
                       <form class="form-horizontal" role="form">
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control select-input" id="inputEmail3" placeholder="Product-title">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <select  class="form-control select-input" name="category">
                                      <?php foreach ($allcategory as $c): ?>
                                   
                               
                                      <option><?php echo $c['cat_title']; ?></option>
                                        <?php endforeach; ?>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" rows="6"style="width: 40em;"></textarea>
                              </div> 
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control select-input" id="inputEmail3" placeholder="Product-price">
                              </div>
                            </div>
