...
class User extends CI_Controller {
	...
	function create_user()
	{
		$this->data['title'] = "Create User";
                $this->data['groupname'] = $this->ion_auth_model->get_groups();
...
//		}
		...
		$this->form_validation->set_rules('phone', $this->lang->line('create_user_validation_phone_label'), 'required|xss_clean');
                $this->form_validation->set_rules('country', $this->lang->line('create_user_validation_zipcode_label'), 'required|xss_clean');
                $this->form_validation->set_rules('zipcode', $this->lang->line('create_user_validation_poboxno_label'), 'required|xss_clean');
                $this->form_validation->set_rules('poboxno', $this->lang->line('create_user_validation_country_label'), 'required|xss_clean');
