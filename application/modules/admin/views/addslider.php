...
<div id="page-wrapper">
            ...
            <div class="row">
                       <form class="form-horizontal" role="form" name="uploadform" method="post" action="<?php echo site_url(); ?>/slider/addtoslider" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label"><a>Title</a></label>
                              <div class="col-sm-10">
                                <input type="text" name="title" class="form-control select-input" id="inputEmail3" placeholder="slider-title">
                              </div>
                            </div>
                            <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" rows="6"style="width: 40em;" name="description">Description</textarea>
                              </div> 
                           </div>
