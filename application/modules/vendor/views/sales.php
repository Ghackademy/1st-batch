                    ...
                    <div class="nav1Content">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="<?php echo site_url();?>/vendor/logout">Logout</a></li>
...
<!--                <div class="btn-group">
                ...
                <!--sales-->
                <div class="btn-group">
                    <div class="nav2Menu" data-toggle="dropdown"><a href="<?php echo site_url();?>/vendor/sales">Sales </a></div>
                   
                </div>
                
                <!--contactus-->
                <div class="btn-group">
                    <div class="nav2Menu" data-toggle="dropdown"><a href="#">Contact us</a></div>
                    
                </div>
                <!--about us-->
                <div class="btn-group">
                    <div class="nav2Menu" data-toggle="dropdown"><a href="#">About us </a></div>
