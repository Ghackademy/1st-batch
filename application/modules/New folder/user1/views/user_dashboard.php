...
<html>
    ...
    <body>
     ...
     <div class="nav3Wrapper">
            <div class="nav3Contents container">
                <div class="welcomecontent col-lg-1 col-md-1 col-sm-12 col-xs-12 pull-right"> 
                    <img src="<?php echo base_url();?>assests/images/jessica alba face.jpg" height="50" width="50" alt="no img">
                    <!--<p class="welcometitle"> welcome!user </p>-->
 ...
 <div class="item  active">
        ...
        <footer>
            ...
            <div class="container">
                <div class="row">
                    <div class="footer2">
                        <div class="col-md-8 col-lg-8 col-xs-12 col-sm-12 footernoteleft">
                            <div class="SocialIcon">
                                <div class="socialIconBody">
                                    <ul>
